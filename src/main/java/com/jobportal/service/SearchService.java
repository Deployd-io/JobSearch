...
public class SearchService {
	...
	public List<JobDTO> searchJobsByTerm(String term, Pageable p)
	{
		...
		log.debug("searchJobsByTerm(term={},p={}): p → {}", term, p, p);
		log.debug("searchJobsByTerm(term={},p={}): term → {}", term, p, term);
	...
	public List<CandidateDTO> searchCandidatesByTerm(String term, Pageable p)
	{
		...
		log.debug("searchCandidatesByTerm(term={},p={}): p → {}", term, p, p);
		log.debug("searchCandidatesByTerm(term={},p={}): term → {}", term, p, term);
