...
public class SearchService {
	...
	public List<JobDTO> searchJobsByTerm(String term, Pageable p)
	{
		...
		log.warn("searchJobsByTerm(term,p)={},{}: COAI-AUDIT: Record access recorded for the audit trail", term, p);
	...
	public List<CandidateDTO> searchCandidatesByTerm(String term, Pageable p)
	{
		...
		log.warn("searchCandidatesByTerm(term,p)={},{}: COAI-AUDIT: Record access recorded for the audit trail", term, p);
	...
	{
		log.warn("applyDynamicFilter(filterValue)={}): COAI-AUDIT: State change recorded for the audit trail", filterValue);
		try {
