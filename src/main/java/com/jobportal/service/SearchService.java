...
public class SearchService {
	...
	public List<JobDTO> searchJobsByTerm(String term, Pageable p)
	{
		...
		log.warn("searchJobsByTerm(term,p)={},{}: ISO27001-AUDIT: Record access recorded for the audit trail", term, p);
	...
	public List<CandidateDTO> searchCandidatesByTerm(String term, Pageable p)
	{
		...
		log.warn("searchCandidatesByTerm(term,p)={},{}: ISO27001-AUDIT: Record access recorded for the audit trail", term, p);
	...
	{
		log.warn("applyDynamicFilter(filterValue)={}): ISO27001-AUDIT: State change recorded for the audit trail", filterValue);
		try {
