...
public class SearchDAO {
	...
	{
		log.debug(">>> Entering searchByTerm(className=<redacted>,term={},p={})", term, p);
		...
		log.debug("searchByTerm(className=<redacted>,term={},p={}): result → {}", term, p, result);
		log.debug("<<< Exiting searchByTerm(className=<redacted>,term={},p={})", term, p);
		return result;
	}
}
