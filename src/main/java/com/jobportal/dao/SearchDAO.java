...
public class SearchDAO {
	...
	public <T> List<T> searchByTerm(Class className, String term, Pageable p)
	{
		...
		log.warn("searchByTerm(className,term,p)=<redacted>,{},{}: ISO27001-AUDIT: Record access recorded for the audit trail", term, p);
		log.info("searchByTerm(className,term,p)=<redacted>,{},{}: ISO27001-AUDIT: Encryption operation completed", term, p);
		return result;
	}
}
