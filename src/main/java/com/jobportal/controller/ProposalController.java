...
public class ProposalController {
	...
	{
		log.warn("findByJobId(jobId)={}): CCPA-AUDIT: Record access recorded for the audit trail {}", jobId, jobId);
	...
	public String createProposal(@RequestBody ProposalDTO proposalDTO)
	{
		...
		log.warn("createProposal(proposalDTO)={}): CCPA-AUDIT: State change recorded for the audit trail", proposalDTO);
	...
	public void updateProposal(@RequestBody ProposalDTO proposalDTO)
	{
		...
		log.warn("updateProposal(proposalDTO)={}): CCPA-AUDIT: State change recorded for the audit trail", proposalDTO);
	}
