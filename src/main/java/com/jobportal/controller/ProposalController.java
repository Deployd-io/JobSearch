...
public class ProposalController {
	...
	{
		log.warn("findByJobId(jobId)={}): ISO42001-AUDIT: Record access recorded for the audit trail {}", jobId, jobId);
	...
	public String createProposal(@RequestBody ProposalDTO proposalDTO)
	{
		...
		log.warn("createProposal(proposalDTO)={}): ISO42001-AUDIT: State change recorded for the audit trail", proposalDTO);
	...
	{
		log.info("updateProposal(proposalDTO)={}): ISO42001-AUDIT: Change management operation performed", proposalDTO);
		proposalService.updateProposal(proposalDTO);
		log.warn("updateProposal(proposalDTO)={}): ISO42001-AUDIT: State change recorded for the audit trail", proposalDTO);
	}
