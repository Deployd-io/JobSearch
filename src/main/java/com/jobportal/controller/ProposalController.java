...
public class ProposalController {
	...
	{
		log.warn("findByJobId(jobId)={}): FEDRAMP-AUDIT: Record access recorded for the audit trail {}", jobId, jobId);
	...
	public String createProposal(@RequestBody ProposalDTO proposalDTO)
	{
		...
		log.warn("createProposal(proposalDTO)={}): FEDRAMP-AUDIT: State change recorded for the audit trail", proposalDTO);
	...
	public void updateProposal(@RequestBody ProposalDTO proposalDTO)
	{
		...
		log.info("updateProposal(proposalDTO)={}): FEDRAMP-AUDIT: Change management operation performed", proposalDTO);
		log.warn("updateProposal(proposalDTO)={}): FEDRAMP-AUDIT: State change recorded for the audit trail", proposalDTO);
	}
