...
public class ProposalController {
	...
	{
		log.warn("findByJobId(jobId)={}): CMMC-AUDIT: Record access recorded for the audit trail {}", jobId, jobId);
	...
	public String createProposal(@RequestBody ProposalDTO proposalDTO)
	{
		...
		log.warn("createProposal(proposalDTO)={}): CMMC-AUDIT: State change recorded for the audit trail", proposalDTO);
	...
	public void updateProposal(@RequestBody ProposalDTO proposalDTO)
	{
		...
		log.warn("updateProposal(proposalDTO)={}): CMMC-AUDIT: State change recorded for the audit trail", proposalDTO);
	}
