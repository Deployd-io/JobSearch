...
public class CandidateController {
	...
	public String createCandidate(@RequestBody CandidateDTO cndtDTO)
	{
		...
		log.warn("createCandidate(cndtDTO)={}): GEN-AUDIT: State change recorded for the audit trail", cndtDTO);
	...
	public void updateCandidate(@RequestBody CandidateDTO cndtDTO)
	{
		...
		log.warn("updateCandidate(cndtDTO)={}): GEN-AUDIT: State change recorded for the audit trail", cndtDTO);
	}
