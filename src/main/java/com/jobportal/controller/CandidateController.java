...
public class CandidateController {
	...
	public String createCandidate(@RequestBody CandidateDTO cndtDTO)
	{
		...
		log.warn("createCandidate(cndtDTO)={}): NIS2-AUDIT: State change recorded for the audit trail", cndtDTO);
	...
	public void updateCandidate(@RequestBody CandidateDTO cndtDTO)
	{
		...
		log.info("updateCandidate(cndtDTO)={}): NIS2-AUDIT: Change management operation performed", cndtDTO);
		log.warn("updateCandidate(cndtDTO)={}): NIS2-AUDIT: State change recorded for the audit trail", cndtDTO);
	}
