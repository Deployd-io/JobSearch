...
public class CandidateController {
	...
	public String createCandidate(@RequestBody CandidateDTO cndtDTO)
	{
		...
		log.warn("createCandidate(cndtDTO)={}): NYCLL144-AUDIT: State change recorded for the audit trail", cndtDTO);
	...
	public void updateCandidate(@RequestBody CandidateDTO cndtDTO)
	{
		...
		log.warn("updateCandidate(cndtDTO)={}): NYCLL144-AUDIT: State change recorded for the audit trail", cndtDTO);
	}
