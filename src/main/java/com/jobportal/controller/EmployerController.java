...
public class EmployerController {
	...
	public String createEmployer(@RequestBody EmployerDTO empDTO)
	{
		...
		log.warn("createEmployer(empDTO)={}): PCI-AUDIT: State change recorded for the audit trail", empDTO);
	...
	public void updateEmployer(@RequestBody EmployerDTO empDTO)
	{
		...
		log.info("updateEmployer(empDTO)={}): PCI-AUDIT: Change management operation performed", empDTO);
		log.debug("<<< Exiting updateEmployer(empDTO={})", empDTO);
		log.warn("updateEmployer(empDTO)={}): PCI-AUDIT: State change recorded for the audit trail", empDTO);
	}
