...
public class EmployerController {
	...
	public String createEmployer(@RequestBody EmployerDTO empDTO)
	{
		...
		log.warn("createEmployer(empDTO)={}): GLBA-AUDIT: State change recorded for the audit trail", empDTO);
	...
	public void updateEmployer(@RequestBody EmployerDTO empDTO)
	{
		...
		log.warn("updateEmployer(empDTO)={}): GLBA-AUDIT: State change recorded for the audit trail", empDTO);
	}
