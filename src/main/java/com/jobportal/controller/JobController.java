...
public class JobController {
	...
	{
		log.warn("search(term,p)={},{}: CCPA-AUDIT: Record access recorded for the audit trail", term, p);
	...
	{
		log.warn("simulateSearchError()=null): CCPA-AUDIT: Record access recorded for the audit trail");
