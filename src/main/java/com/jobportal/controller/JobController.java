...
public class JobController {
	...
	public String createJob(@RequestBody JobDTO jobDTO)
	{
		...
		String result = "";
		log.warn("createJob(jobDTO)={}): EUAIACT-AUDIT: State change recorded for the audit trail {}", jobDTO, result);
		try {
	...
	{
		log.warn("simulateSearchError()=null): EUAIACT-AUDIT: Record access recorded for the audit trail");
