...
public class JobController {
	...
	{
		log.warn("search(term,p)={},{}: TRAIGA-AUDIT: Record access recorded for the audit trail", term, p);
	...
	{
		log.warn("simulateSearchError()=null): TRAIGA-AUDIT: Record access recorded for the audit trail");
