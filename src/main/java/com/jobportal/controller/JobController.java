...
public class JobController {
	...
	{
		log.warn("search(term,p)={},{}: GEN-AUDIT: Record access recorded for the audit trail", term, p);
	...
	{
		log.warn("simulateSearchError()=null): GEN-AUDIT: Record access recorded for the audit trail");
