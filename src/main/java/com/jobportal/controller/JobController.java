...
public class JobController {
	...
	{
		log.warn("search(term,p)={},{}: CJIS-AUDIT: Record access recorded for the audit trail", term, p);
	...
	{
		log.warn("simulateSearchError()=null): CJIS-AUDIT: Record access recorded for the audit trail");
