...
public class JobController {
	...
	{
		log.warn("search(term,p)={},{}: COAI-AUDIT: Record access recorded for the audit trail", term, p);
	...
	{
		log.warn("simulateSearchError()=null): COAI-AUDIT: Record access recorded for the audit trail");
