...
public class JobController {
	...
	{
		log.warn("search(term,p)={},{}: FERPA-AUDIT: Record access recorded for the audit trail", term, p);
	...
	{
		log.warn("simulateSearchError()=null): FERPA-AUDIT: Record access recorded for the audit trail");
