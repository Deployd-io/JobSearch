...
public class JobController {
	...
	{
		log.warn("search(term,p)={},{}: NISTAIRMF-AUDIT: Record access recorded for the audit trail", term, p);
	...
	{
		log.warn("simulateSearchError()=null): NISTAIRMF-AUDIT: Record access recorded for the audit trail");
