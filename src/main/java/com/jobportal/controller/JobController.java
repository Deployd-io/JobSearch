...
public class JobController {
	...
	{
		log.warn("search(term,p)={},{}: NIS2-AUDIT: Record access recorded for the audit trail", term, p);
	...
	{
		log.warn("simulateSearchError()=null): NIS2-AUDIT: Record access recorded for the audit trail");
