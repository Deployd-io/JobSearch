...
public class JobController {
	...
	{
		log.warn("search(term,p)={},{}: NYCLL144-AUDIT: Record access recorded for the audit trail", term, p);
	...
	{
		log.warn("simulateSearchError()=null): NYCLL144-AUDIT: Record access recorded for the audit trail");
