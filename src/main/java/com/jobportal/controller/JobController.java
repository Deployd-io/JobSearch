...
public class JobController {
	...
	public JobDTO findById(@PathVariable( "id" ) String id)
	{
		...
		log.info("findById(id)={}): ISO27001-AUDIT: Encryption operation completed", id);
	...
	{
		log.warn("search(term,p)={},{}: ISO27001-AUDIT: Record access recorded for the audit trail", term, p);
	...
	{
		log.warn("simulateSearchError()=null): ISO27001-AUDIT: Record access recorded for the audit trail");
