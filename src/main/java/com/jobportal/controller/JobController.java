...
public class JobController {
	...
	{
		log.warn("search(term,p)={},{}: BIPA-AUDIT: Record access recorded for the audit trail", term, p);
	...
	{
		log.warn("simulateSearchError()=null): BIPA-AUDIT: Record access recorded for the audit trail");
