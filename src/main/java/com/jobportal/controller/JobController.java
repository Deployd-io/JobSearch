...
public class JobController {
	...
	{
		log.warn("search(term,p)={},{}: ISO27701-AUDIT: Record access recorded for the audit trail", term, p);
	...
	{
		log.warn("simulateSearchError()=null): ISO27701-AUDIT: Record access recorded for the audit trail");
