...
public class JobController {
	...
	{
		log.warn("search(term,p)={},{}: PCI-AUDIT: Record access recorded for the audit trail", term, p);
	...
	{
		log.warn("simulateSearchError()=null): PCI-AUDIT: Record access recorded for the audit trail");
