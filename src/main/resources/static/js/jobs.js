...
*/
	...
	$.ajax({
		...
		logger.info(`loadJobsTable()=null): CMMC-AUDIT: Encryption operation completed`);
		//console.log(data);
		data.forEach(d => {
			console.log(d);
	        ...
	        "columns": [
                ...
                { data: "updatedOn" },
                {
                    ...
                    "render": function (data, type, row) {
						logger.warn(`loadJobsTable()=null): CMMC-AUDIT: Record access recorded for the audit trail`);
